...
export function qiKe(
    ...
    // console.log(indexGui)
    // const ke = ;
    // ke.useData();
    return new QiKe(indexDi, indexTian, indexGui);
}

// 断课信息

const answerBase = ref<
    Array<
        [GanZhi.EarthlyBranch | "", GanZhi.EarthlyBranch | "", GanZhi.GuiRen | ""]
    >
>(new Array(12).fill(new Array(3).fill("")));

// const answerThree = ref<Array<[string, GanZhi.EarthlyBranch, GanZhi.GuiRen]>>(
//   [],
// );
