        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    {
                        text: '1、参天量地的工具',
                        link: "/2、卜的基础/1、参天量地的工具",
                    },
                    {
                        text: '2、地支学的运算',
                        link: "/2、卜的基础/2、地支学的运算",
                    },
                    {
                        text: "3、气的流转",
                        link: "/2、卜的基础/3、气的流转"
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        // link: "/3、大六壬基础/4、 十二天神"
                        items: [
                            {text: "亥", link: "/3、大六壬基础/4-1、亥"},
                            {text: "戌", link: "/3、大六壬基础/4-2、戌"},
                            {text: "酉", link: "/3、大六壬基础/4-3、酉"},
                            {text: "申", link: "/3、大六壬基础/4-4、申"},
                            {text: "未", link: "/3、大六壬基础/4-5、未"},
                            {text: "午", link: "/3、大六壬基础/4-6、午"},
                            {text: "巳", link: "/3、大六壬基础/4-7、巳"},
                            {text: "辰", link: "/3、大六壬基础/4-8、辰"},
                            {text: "卯", link: "/3、大六壬基础/4-9、卯"},
                            {text: "寅", link: "/3、大六壬基础/4-10、寅"},
                            {text: "丑", link: "/3、大六壬基础/4-11、丑"},
                            {text: "子", link: "/3、大六壬基础/4-12、子"},
                        ]
                    },
                    {
                        text: "5、 十二天将",
                        ...
                        // link: "/3、大六壬基础/5、 十二天将"
                        items: [
                            {text: "贵人", link: "/3、大六壬基础/5-1、贵人"},
                            {text: "螣蛇", link: "/3、大六壬基础/5-2、螣蛇"},
                            {text: "朱雀", link: "/3、大六壬基础/5-3、朱雀"},
                            {text: "六合", link: "/3、大六壬基础/5-4、六合"},
                            {text: "勾陈", link: "/3、大六壬基础/5-5、勾陈"},
                            {text: "青龙", link: "/3、大六壬基础/5-6、青龙"},
                            {text: "天空", link: "/3、大六壬基础/5-7、天空"},
                            {text: "白虎", link: "/3、大六壬基础/5-8、白虎"},
                            {text: "太常", link: "/3、大六壬基础/5-9、太常"},
                            {text: "玄武", link: "/3、大六壬基础/5-10、玄武"},
                            {text: "太阴", link: "/3、大六壬基础/5-11、太阴"},
                            {text: "天后", link: "/3、大六壬基础/5-12、天后"},
                        ]
                    },
                    {
                        text: "6、神煞",
