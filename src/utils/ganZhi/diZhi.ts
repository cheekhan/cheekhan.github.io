import { YinYang, WuXing, ZhiName, EarthlyBranch, DiZhiList } from "./types";
...
export class BranchZi extends EarthlyBranch {
  ...
  getSanHe(target1: EarthlyBranch, target2: EarthlyBranch): Promise<WuXing> {
    if (
...
/** 获取没有副作用的数组 */
export function useDizhiList(start?: EarthlyBranch): DiZhiList {
  const _arr: DiZhiList = [
    new BranchZi(),
    new BranchChou(),
    new BranchYin(),
    new BranchMao(),
